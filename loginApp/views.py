            ...
            if complaint:
                ...
                if status in dict(Complaint.STATUS_CHOICES):
                    ...
                    if previous_status != status and complaint.user and complaint.user.email:
                        ...
                        message = f'Your complaint status has changed to {complaint.get_status_display()}.'
                        if status == 'reviewed':
